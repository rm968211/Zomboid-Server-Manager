...
export default function SiteSettings({
    ...
    /* File selection is an external browser input, so these effects intentionally
       synchronize object-URL previews into component state. */
    ...
    const isDirty =
        ...
        JSON.stringify(landingSections) !==
            JSON.stringify(settings.landing_sections) ||
        JSON.stringify(themeColors) !==
            JSON.stringify(settings.theme_colors ?? {}) ||
        logoFile !== null ||
        faviconFile !== null;
    ...
    async function save() {
        ...
        landingSections.forEach((section, i) => {
            ...
            formData.append(
                `landing_sections[${i}][enabled]`,
                section.enabled ? '1' : '0',
            );
            formData.append(
                `landing_sections[${i}][order]`,
